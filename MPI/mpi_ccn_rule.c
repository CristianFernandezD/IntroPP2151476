...
/*
  ...
  Modificaci贸n del m閠odo:

    Este m茅todo se ha modificado para que las variables N, A, B y 
    ...
    Otra modificaci贸n que se ha hecho al m茅todo, es la construcci贸n
    de un c贸digo para determinar el tiempo que tarda en ejecutar el
    algoritmo. Este c贸digo fue tomado en base al del enlace, aunque
...
*/
    printf ( "  Los valores N, A, B y FILENAME fueron asignados para facilitar el an谩lisis.\n" );
    printf ( "\n" );
...
/*
  C贸digo MPI
*/
    printf ( " C贸digo paralelizado con MPI.\n" );
    printf ( " N煤mero de procesos = %d\n ", num_procs );
  }
/*
  Get N.
*/
...
/*
  Esto pone en pausa la salida del algoritmo para poder observar mejor la compilaci髇 en el sistema local.
*/
  system("PAUSE");
